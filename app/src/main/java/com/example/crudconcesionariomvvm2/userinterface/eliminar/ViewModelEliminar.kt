package com.example.crudconcesionariomvvm2.userinterface.eliminar
                ...
                if (documentSnapshot.exists()) {
                    documentSnapshot.reference.delete()
                        .addOnSuccessListener {
                            _confirmation_message.value = "ÉXITO: Coche borrado de la base de datos."
                            _id.value = ""
                        }
                    ...
                    _confirmation_message.value = "ERROR: El coche buscado no existe en la base de datos."
                }
            }
            .addOnFailureListener {
                _confirmation_message.value = "ERROR: Ha habido un error. Por favor inténtelo de nuevo o más tarde."
